...
<div class="bg-green-100 text-green-900 p-8 pt-24">
    ...
    <div class="mx-auto container relative">
            ...
            <a href="#" class="font-display text-lg border-2 border-green-900 px-10 py-3 uppercase font-bold self-center hidden md:block bg-white md:absolute right-0 top-0">RESPOND</a>

        <!-- Logos & Attribution -->
        <div class="flex flex-row-reverse mb-5   xl:scale-up-2x md:absolute bottom-0 -ml-12 left-full">
            @component('attribution')            
            @endcomponent
        </div>

        <!-- Heading -->
        <div class="text-green-900 px-4 leading-tight flex flex-col w-full">
            <span class="font-display text-6xl uppercase  order-1   |   md:text-10xl   md:-mb-32 ">Global</span>
            <span class="font-display text-6xl uppercase self-end order-3  |    md:text-10xl  ">Peace</span>
            <span class="font-cursive text-center self-end leading-normal my-3 w-32 text-xs  order-4  |  md:order-2 md:text-2xl md:w-1/3 md:leading-loose" >Contribute a line or stanza to a global peace poem</span>
            <span class="font-display text-6xl uppercase  ml-2 order-5 | md:text-10xl lg:ml-24">Poem</span>
        </div>
    </div>

    <div class="md:container md:mx-auto md:flex md:justify-center md:max-w-xl" >
        <scrolly-globe class="w-full -mb-50vw mt-16 scale-up md:scale-none  lg:scale-up self-center md:-mt-64 md:-mb-70" ></scrolly-globe>
    </div>
</div>
...
<div class="bg-yellow-900 p-8 pt-32 pb-48 text-green-900 ">
    ...
    <div class="container md:mx-auto relative mt-24 md:mt-24 flex flex-col lg:mt-48">
        ...
        <div class="bg-white  p-10 -mt-10 relative pt-16 pb-32   |  xl:mt-0  md:max-w-sm   xl:scale-up">
        ...
        <div class="relative  md:max-w-sm w-full lg:scale-up md:m-10 md:self-end mt-24 xl:-mt-16" style="height: 30rem">
