<div id="{{ $response->id }}" class="response text-primary w-full md:w-1/2 lg:w-1/3 {{$isHighlighted ? 'highlight' : 'transition'}} md:p-4 mb-8" style="opacity: 0; transform: translateY(.5rem); transition-delay: {{$delay ?? 40}}ms">
    ...
    <div class="controls hidden w-12 h-10 absolute" style="transform: rotate(-45deg)">
        ...
        <button class="close bg-primary text-secondary rounded-full overflow-hidden w-12 h-12 p-4 absolute cursor-pointer uppercase text-sm" style="top: 50%; left: -100%; transform: translate(0, -50%); filter: drop-shadow(0 0 0.75rem #444);">
        ...
        <button class="copy bg-primary text-secondary rounded-full overflow-hidden w-12 h-12 p-2 absolute cursor-pointer uppercase text-sm" style="top: 50%; left: 100%; transform: translate(0, -50%); filter: drop-shadow(0 0 0.75rem #444);">
            <svg class="success-icon" x="0px" y="0px" viewBox="0 0 100 100"><g transform="translate(0,-952.36218)"><path style="text-indent:0;text-transform:none;direction:ltr;block-progression:tb;baseline-shift:baseline;enable-background:accumulate;" d="m 80.878285,977.33819 a 5.0005,5.0005 0 0 0 -3.4374,1.5 l -36.9063,36.90631 -18.5,-14.3126 a 5.0006103,5.0006103 0 1 0 -6.125,7.9063 l 22,17 a 5.0005,5.0005 0 0 0 6.5937,-0.4062 l 40,-40.00006 a 5.0005,5.0005 0 0 0 -3.625,-8.59375 z" fill="currentColor" fill-opacity="1" stroke="none" marker="none" visibility="visible" display="inline" overflow="visible"></path></g></svg>
        ...
        <button data-share-link="{{ $response->getUrl() }}" class="share bg-primary text-secondary rounded-full overflow-hidden w-12 h-12 absolute cursor-pointer uppercase text-sm" style="top: -100%; left: 50%; transform: translate(-50%, 0); filter: drop-shadow(0 0 0.75rem #444);">
            <svg class="success-icon p-2" x="0px" y="0px" viewBox="0 0 100 100"><g transform="translate(0,-952.36218)"><path style="text-indent:0;text-transform:none;direction:ltr;block-progression:tb;baseline-shift:baseline;enable-background:accumulate;" d="m 80.878285,977.33819 a 5.0005,5.0005 0 0 0 -3.4374,1.5 l -36.9063,36.90631 -18.5,-14.3126 a 5.0006103,5.0006103 0 1 0 -6.125,7.9063 l 22,17 a 5.0005,5.0005 0 0 0 6.5937,-0.4062 l 40,-40.00006 a 5.0005,5.0005 0 0 0 -3.625,-8.59375 z" fill="currentColor" fill-opacity="1" stroke="none" marker="none" visibility="visible" display="inline" overflow="visible"></path></g></svg>
        ...
        @if ($space->allow_printing)
            <button class="print bg-primary text-secondary rounded-full overflow-hidden w-12 h-12 p-3 absolute cursor-pointer uppercase text-sm" style="top: 100%; left: 50%; transform: translate(-50%, 0%); filter: drop-shadow(0 0 0.75rem #444);">
                <svg class="w-full" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
