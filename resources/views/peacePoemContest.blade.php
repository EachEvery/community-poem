...
<div class="bg-blue-100 text-green-900 p-8 pt-32 lg:px-32 xl:px-48">
    <div class="container md:mx-auto lg:flex justify-between" style="max-width: 65rem">
        <div class="md:max-w-sm lg:mr-10 xl:mr-0">
            ...
            <a href="https://wickpoetrycenter.submittable.com/submit/145883/national-call-for-poems" class="inline-block font-display bg-white text-lg border-2 border-green-900 px-8 py-3 uppercase font-bold mt-10">Respond</a>
        </div>
